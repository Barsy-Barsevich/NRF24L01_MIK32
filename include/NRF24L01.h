...
#define NRF_RF_SETUP_RF_DR_LOW_M        (1<<NRF_RF_SETUP_RF_DR_LOW) 
#define NRF_RF_SETUP_RF_DR_HIGH         3
#define NRF_RF_SETUP_RF_DR_HIGH_M       (1<<NRF_RF_SETUP_RF_DR_HIGH)
#define NRF_RF_SETUP_RF_PWR             1
#define NRF_RF_SETUP_RF_PWR_M           (0b11<<NRF_RF_SETUP_RF_PWR)
/* NRF_STATUS */
#define NRF_STATUS_RX_DR                6
#define NRF_STATUS_RX_DR_M              (1<<NRF_STATUS_RX_DR)
#define NRF_STATUS_TX_DS                5
#define NRF_STATUS_TX_DS_M              (1<<NRF_STATUS_TX_DS)
#define NRF_STATUS_MAX_RT               4
#define NRF_STATUS_MAX_RT_M             (1<<NRF_STATUS_MAX_RT)
#define NRF_STATUS_RX_P_NO              1
#define NRF_STATUS_RX_P_NO_M            0x111<<NRF_STATUS_RX_P_NO
#define NRF_STATUS_TX_FULL              0
#define NRF_STATUS_TX_FULL_M            (1<<NRF_STATUS_TX_FULL)
